==================================
Eigenmode-source validation matrix
==================================
...
The final ``y`` in every validation ``#eigenmode_source`` command intentionally
...
.. code-block:: console
   ...
   python testing/validation/eigenmode_sources/run_all.py
...
.. code-block:: console
   ...
   python testing/validation/eigenmode_sources/run_all.py \
       --root testing/validation/eigenmode_sources/cases/two_dimensional \
       --dry-run --skip-plots
