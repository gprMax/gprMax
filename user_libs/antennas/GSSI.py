...
def antenna_like_GSSI_1500(x, y, z, resolution=0.001, rotate90=False):
    ...
    if optstate == "WarrenThesis":
        ...
        print(
            "#add_dispersion_debye: 3 3.7733 1.00723e-11 3.14418 1.55686e-10 20.2441 3.44129e-10 absorber1"
    ...
    if optstate == "WarrenThesis" or optstate == "DebyeAbsorber":
        ...
        print(
            "#excitation_file: ../user_libs/antennas/GSSI1p5optpulse.txt linear extrapolate"
        )
        voltage_source(
            "y",
            tx[0],
...
def antenna_like_GSSI_400(x, y, z, resolution=0.001, rotate90=False):
    ...
    src_type = (
        "voltage_source"  # # source type. "voltage_source" or "transmission_line"
    )
    ...
    if resolution == 0.0005:
        ...
        raise CmdInputError(
            "This antenna module can only be used with a spatial discretisation of 0.5mm, 1mm, 2mm"
        )
    ...
    if smooth_dec == "yes":
        ...
        box(
            ...
            "absorber",
            rotate90origin=rotate90origin,
        )  # new 4 (0.292 x 0.292 x 0.086)

        # PCB
        if resolution == 0.0005:
            box(
                x + 0.01 + 0.005 + 0.018,
                y + casethickness + 0.005 + 0.0235,
                z + skidthickness,
