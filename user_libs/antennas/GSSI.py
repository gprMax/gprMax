...
def antenna_like_GSSI_400_model2022(x, y, z, resolution=0.002, rotate90=False):
    """Inserts a description of an antenna similar to the GSSI 400MHz antenna. 
    This model represents an update to the previous model of the 400MHz antenna and was created and optimised by Stadler et al. (2022) in: https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9686638 . 
    Can be used with 0.5mm, 1mm (default) or 2mm spatial resolution. The external dimensions of the antenna are 300x300x178mm. One output point is defined between the arms of the receiver bowtie. The bowties are aligned with the y axis so the output is the y component of the electric field.
    ...
    smooth_dec = 'yes',
    src_type='GSSI400MHzpulse',
    excitationfreq=3.5e8, # defined here, only used for 'voltage_source' type excitation
    sourceresistance=257.97407389585214,
    receiverresistance=288.92728542970417,
    absorberEr=2.42966922703319,
    absorbersig=0.03839822151712033,
    ...
    if smooth_dec == 'yes':
        ...
        if resolution == 0.0005:
            ...
            box(x + 0.01 + 0.005 + 0.017, y + casethickness + 0.005 + 0.021, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.033 + bowtiebase, y + casethickness + 0.006 + 0.202 + patchheight, z + skidthickness + pcbthickness-0.002, 'pcb', rotate90origin=rotate90origin)    # new (for use with edges)
            box(x + 0.01 + 0.005 + 0.179, y + casethickness + 0.005 + 0.021, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.195 + bowtiebase, y + casethickness + 0.006 + 0.202 + patchheight, z + skidthickness + pcbthickness-0.002, 'pcb', rotate90origin=rotate90origin)   # new (for use with edges)
        ...
        if resolution == 0.0005:
            ...
            box(x + 0.01 + 0.005 + 0.017, y + casethickness + 0.005 + 0.021, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.033 + bowtiebase, y + casethickness + 0.006 + 0.202 + patchheight, z + skidthickness + pcbthickness-0.002, 'pcb', 'n', rotate90origin=rotate90origin)    # new (for use with edges)
            box(x + 0.01 + 0.005 + 0.179, y + casethickness + 0.005 + 0.021, z + skidthickness, x + 0.01 + 0.005 + 0.195 + bowtiebase, y + casethickness + 0.006 + 0.202 + patchheight, z + skidthickness + pcbthickness, 'pcb', 'n', rotate90origin=rotate90origin)   # new (for use with edges)
    ...
    if resolution == 0.0005:
        ...
        edge(tx[0], tx[1] + dy, tx[2], tx[0], tx[1] + 2*dy, tx[2], 'pec', rotate90origin=rotate90origin)
            ...
            # "left" side
            # extension plates
            plate(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.021, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.021 + patchheight, z + skidthickness-0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # box(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.021, z + skidthickness, x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.021 + patchheight, z + skidthickness + 0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            plate(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.203 + patchheight, z + skidthickness-0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # box(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.203, z + skidthickness, x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.203 + patchheight, z + skidthickness + 0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            ...
            # triangle(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.081, z + skidthickness,
                     ...
                     # x + 0.01 + 0.005 + 0.025 + (bowtiebase/2), y + casethickness + 0.005 + 0.081 + bowtieheight, z + skidthickness,
                     # 0.002,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            triangle(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.081, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.081, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.025 + (bowtiebase/2), y + casethickness + 0.005 + 0.081 + bowtieheight, z + skidthickness-0.002,
                     0,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # triangle(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.203, z + skidthickness,
                     # x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.203, z + skidthickness,
                     # x + 0.01 + 0.005 + 0.025 + (bowtiebase/2), y + casethickness + 0.005 + 0.203 - bowtieheight, z + skidthickness,
                     # 0.002,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            triangle(x + 0.01 + 0.005 + 0.025, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.025 + bowtiebase, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.025 + (bowtiebase/2), y + casethickness + 0.005 + 0.203 - bowtieheight, z + skidthickness-0.002,
                     0,'pec', rotate90origin=rotate90origin) # new (for use with edges)

            # "right" side
            plate(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.021, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.021 + patchheight, z + skidthickness-0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # box(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.021, z + skidthickness, x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.021 + patchheight, z + skidthickness + 0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            plate(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002, x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.203 + patchheight, z + skidthickness-0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # box(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.203, z + skidthickness, x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.203 + patchheight, z + skidthickness + 0.002, 'pec', rotate90origin=rotate90origin) # new (for use with edges)
            ...
            # triangle(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.081, z + skidthickness,
                     ...
                     # x + 0.01 + 0.005 + 0.187 + (bowtiebase/2), y + casethickness + 0.005 + 0.081 + bowtieheight, z + skidthickness,
                     # 0.002,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            triangle(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.081, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.081, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.187 + (bowtiebase/2), y + casethickness + 0.005 + 0.081 + bowtieheight, z + skidthickness-0.002,
                     0,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            # triangle(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.203, z + skidthickness,
                     # x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.203, z + skidthickness,
                     # x + 0.01 + 0.005 + 0.187 + (bowtiebase/2), y + casethickness + 0.005 + 0.203 - bowtieheight, z + skidthickness,
                     # 0.002,'pec', rotate90origin=rotate90origin) # new (for use with edges)
            triangle(x + 0.01 + 0.005 + 0.187, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.187 + bowtiebase, y + casethickness + 0.005 + 0.203, z + skidthickness-0.002,
                     x + 0.01 + 0.005 + 0.187 + (bowtiebase/2), y + casethickness + 0.005 + 0.203 - bowtieheight, z + skidthickness-0.002,
                     0,'pec', rotate90origin=rotate90origin) # new (for use with edges)
    ...
    print('#waveform: gaussian 1 {} myGaussian'.format(excitationfreq))
    if src_type == 'voltage_source':
        print('#voltage_source: y {} {} {} {} myGaussian 0 6e-9'.format(tx[0], tx[1], tx[2], sourceresistance))    # with 3.5e8 center frequency, stop voltage source at ~ 6 ns
    elif src_type == 'transmission_line':
        print('#transmission_line: y {} {} {} {} myGaussian 0 6e-9'.format(tx[0], tx[1], tx[2], sourceresistance))
    elif src_type != 'transmission_line' and src_type != 'voltage_source':
        print("#excitation_file: ../user_libs/antennas/GSSI400MHzpulse.txt"))  # !!! Custom GSSI feed pulse !! Check again
        # print('#voltage_source: y {} {} {} {} my_pulse 0 {}'.format(tx[0], tx[1], tx[2], sourceresistance, 16e-9))
        print('#voltage_source: y {} {} {} {} my_pulse'.format(tx[0], tx[1], tx[2], sourceresistance)) # don't shut off source
        # print('#transmission_line: y {} {} {} {} my_pulse 0 {}'.format(tx[0], tx[1], tx[2], sourceresistance, 16e-9))
    ...
    if resolution == 0.001 or resolution == 0.0005:
        ...
        elif src_type == 'voltage_source' or src_type != 'transmission_line':
            print('#voltage_source: y {} {} {} {} my_zero_src'.format(tx[0] + 0.162, tx[1], tx[2], receiverresistance))
