...
def get_user_objects(processedlines, check=True):
    ...
    multiple_user_objs, rand_params_multi, data_labels_multi = process_multicmds(parsed_commands[1], domain_bounds, hash_count_multiplecmds)

    # Process geometry commands in the order they were given
    geometry_user_objs, rand_params_geo, data_labels_geo = process_geometrycmds(parsed_commands[2], domain_bounds, hash_count_geometrycmds)
