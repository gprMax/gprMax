...
def solve_gpu(currentmodelrun, modelend, G):
    ...
    # Each source type compiled separately as NSOURCES differs per type
    if G.voltagesources + G.hertziandipoles + G.magneticdipoles:
        if G.hertziandipoles:
            ...
            updatecoeffsE = kernels_hertzian.get_global('updatecoeffsE')[0]
            updatecoeffsH = kernels_hertzian.get_global('updatecoeffsH')[0]
            drv.memcpy_htod(updatecoeffsE, G.updatecoeffsE)
            drv.memcpy_htod(updatecoeffsH, G.updatecoeffsH)
        ...
        if G.magneticdipoles:
            ...
            updatecoeffsE = kernels_magnetic.get_global('updatecoeffsE')[0]
            updatecoeffsH = kernels_magnetic.get_global('updatecoeffsH')[0]
            drv.memcpy_htod(updatecoeffsE, G.updatecoeffsE)
            drv.memcpy_htod(updatecoeffsH, G.updatecoeffsH)
        ...
        if G.voltagesources:
            ...
            updatecoeffsE = kernels_voltage.get_global('updatecoeffsE')[0]
            updatecoeffsH = kernels_voltage.get_global('updatecoeffsH')[0]
            drv.memcpy_htod(updatecoeffsE, G.updatecoeffsE)
            drv.memcpy_htod(updatecoeffsH, G.updatecoeffsH)
