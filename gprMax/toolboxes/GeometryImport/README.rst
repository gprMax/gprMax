...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.GeometryImport volume inspect anatomy.nii.gz

Create an editable label mapping:

.. code-block:: console

    python -m gprMax.toolboxes.GeometryImport volume prepare \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.GeometryImport volume convert \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.GeometryImport mesh inspect model.msh --unit mm
    python -m gprMax.toolboxes.GeometryImport mesh prepare \
        model.msh regions.csv --unit mm
    python -m gprMax.toolboxes.GeometryImport mesh convert \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.GeometryImport.examples.labelled_volume_example
    python -m gprMax.toolboxes.GeometryImport.examples.mesh_example
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.GeometryImport.examples.render_examples \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STLtoVoxel.stltovoxel anatomy_stl \
