...
.. code-block:: matlab
    ...
    addpath("gprMax/toolboxes/Utilities/MATLAB")
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.convert_png2h5 imagefile dx dy dz
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.convert_png2h5 \
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_merge basefilename --remove-files
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_segy myoutput Ez
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_segy myoutput Ez --profile gpr
...
provided in ``gprMax/toolboxes/Utilities/examples/four_metal_bars.in``. In the 2D
...
.. code-block:: none
    ...
    python -m gprMax gprMax/toolboxes/Utilities/examples/four_metal_bars.in \
        -n 151 --geometry-fixed
    python -m gprMax.toolboxes.Utilities.outputfiles_segy \
        gprMax/toolboxes/Utilities/examples/four_metal_bars Ez
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_seg2 myoutput Ez
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_dt1 myoutput Ez \
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.Utilities.outputfiles_seg2 \
        gprMax/toolboxes/Utilities/examples/four_metal_bars Ez
    python -m gprMax.toolboxes.Utilities.outputfiles_dt1 \
        gprMax/toolboxes/Utilities/examples/four_metal_bars Ez \
        --nominal-frequency 1000
