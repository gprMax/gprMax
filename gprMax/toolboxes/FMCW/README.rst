...
* :download:`layered_fmcw_2D.in
  <../../gprMax/toolboxes/FMCW/examples/layered_fmcw_2D.in>`;
* :download:`layered_fmcw_background_2D.in
  <../../gprMax/toolboxes/FMCW/examples/layered_fmcw_background_2D.in>`.

Run both models and inspect the stored paths:

.. code-block:: console

    python -m gprMax gprMax/toolboxes/FMCW/examples/layered_fmcw_2D.in
    python -m gprMax gprMax/toolboxes/FMCW/examples/layered_fmcw_background_2D.in
    python -m gprMax.toolboxes.FMCW inspect layered_fmcw_2D.h5

Then synthesise a RIMFAX-band-like 100 ms up-chirp:

.. code-block:: console

    python -m gprMax.toolboxes.FMCW process layered_fmcw_2D.h5 \
