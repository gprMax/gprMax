...
are retained in :download:`LICENSE <../../gprMax/toolboxes/STEPtoVoxel/LICENSE>`.
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel inspect model.stp \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel prepare model.stp materials.csv \
        --voxel-size 0.0001 0.0001 0.0001
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel convert model.stp materials.csv output \
        --voxel-size 0.0001 0.0001 0.0001
...
.. code-block:: python
    ...
    from gprMax.toolboxes.STEPtoVoxel import translate_reference_geometry
...
.. code-block:: python
    ...
    from gprMax.toolboxes.STEPtoVoxel import load_markers
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel inspect \
        gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/PROBE_FED.stp \
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel prepare \
        gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/PROBE_FED.stp \
        patch_materials.csv \
        --voxel-size 0.00007 0.00007 0.00007
...
.. code-block:: console
    ...
    python -m gprMax.toolboxes.STEPtoVoxel convert \
        gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/PROBE_FED.stp \
        gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/materials.csv \
...
.. image:: ../../gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/probe_fed_70um_views.png
    :width: 100%
...
.. image:: ../../gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/probe_fed_port1_overlay.png
    :width: 75%
...
.. code-block:: console
    ...
    python gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/patch_antenna_geometry.py
...
.. code-block:: console
    ...
    python -m gprMax gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/patch_antenna_geometry.in --geometry-only
...
.. image:: ../../gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/probe_fed_gprmax_reference_overlay.png
    :width: 75%
...
.. figure:: ../../gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/probe_fed_gprmax_patch_view.svg
    :width: 75%
...
.. figure:: ../../gprMax/toolboxes/STEPtoVoxel/examples/patch_antenna/probe_fed_gprmax_coax_view.svg
    :width: 75%
