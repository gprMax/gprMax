...
```bash
python -m gprMax gprMax/toolboxes/gprMaxLogo/model/gprmax_v4_logo.in -gpu 0
```

Render a new transparent master from the resulting snapshot:

```bash
python gprMax/toolboxes/gprMaxLogo/render_logo.py \
  gprMax/toolboxes/gprMaxLogo/model/gprmax_v4_logo.in \
  gprMax/toolboxes/gprMaxLogo/model/gprmax_v4_logo_snaps/logo_fields.h5 \
...
```bash
python gprMax/toolboxes/gprMaxLogo/export_assets.py \
  /tmp/gprmax_v4_logo_master_10000.png gprMax/toolboxes/gprMaxLogo/assets
```
