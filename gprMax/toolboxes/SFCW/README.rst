...
example in ``gprMax/toolboxes/SFCW/examples/cylinder_sfcw_2D.in`` contains a PEC
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.SFCW inspect cylinder_sfcw_2D.h5

Then request, for example, 30 frequencies from 100 MHz to 1.1 GHz:

.. code-block:: none

    python -m gprMax.toolboxes.SFCW process cylinder_sfcw_2D.h5 \
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.SFCW process cylinder_Bscan_2D_merged.h5 \
