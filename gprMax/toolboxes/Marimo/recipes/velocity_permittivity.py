...
def _():
    ...
    from gprMax.toolboxes.Marimo.h5_reader import get_unit_label, load_file
    ...
    from gprMax.toolboxes.Marimo.processing import apply_gain, remove_mean_trace
    from gprMax.toolboxes.Marimo.trace_matrix import stack_traces
