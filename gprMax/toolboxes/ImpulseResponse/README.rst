...
<../../gprMax/toolboxes/ImpulseResponse/examples/cylinder_impulse_2D.in>`.
...
.. code-block:: none
    ...
    python -m gprMax.toolboxes.ImpulseResponse inspect cylinder_impulse_2D.h5

Generate two built-in gprMax pulses from that one run:

.. code-block:: none

    python -m gprMax.toolboxes.ImpulseResponse process cylinder_impulse_2D.h5 \
        --source /srcs/src1 \
