...
//             phi = phi + updatecoeffsdispersive[INDEX2D_MATDISP(materialEx,pole*3)].x * Tx[INDEX4D_T(pole,i_T,j_T,k_T)].x;
...
//         {{REAL}} phi = 0;
//         for (int pole = 0; pole < MAXPOLES; pole++) {
//             phi = phi + updatecoeffsdispersive[INDEX2D_MATDISP(materialEy,pole*3)].x * Ty[INDEX4D_T(pole,i_T,j_T,k_T)].x;
...
//         {{REAL}} phi = 0;
//         for (int pole = 0; pole < MAXPOLES; pole++) {
//             phi = phi + updatecoeffsdispersive[INDEX2D_MATDISP(materialEz,pole*3)].x * Tz[INDEX4D_T(pole,i_T,j_T,k_T)].x;
