...
file = h5py.File('Mie_scattering_cpu_fluxes.out', 'r')
...
fig.text(0.5, 0.85, "Distance between fluxes implementation ran with CPU and Theory: {:.2e}".format(dist),
         ha="center", va="top",
         fontsize=8,
         bbox=dict(facecolor='white', edgecolor='black', boxstyle='round,pad=0.5'))
plt.savefig("Mie_scattering_cpu.png", dpi = 300)
plt.close()