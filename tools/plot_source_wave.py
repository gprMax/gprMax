...
def mpl_plot(w, timewindow, dt, iterations, fft=False):
    ...
    if (
        ...
        w.type == "gaussiandotdot"
        or w.type == "gaussiandotdotnorm"
        or w.type == "ricker"
    ):
    ...
    if fft:
        ...
        fig, ax1 = plt.subplots(
            num=w.type, figsize=(20, 10), facecolor="w", edgecolor="w"
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        usage="cd gprMax; python -m tools.plot_source_wave type amp freq timewindow dt",
    )
    ...
    parser.add_argument(
        "-fft", action="store_true", help="plot FFT of waveform", default=False
    )
